export class OperationConfig {
  static SCHEMA = {
    vector: {
      ...
      zDepth: { type: 'number', default: 0, label: 'Z depth', unit: 'mm' },
      zStep: { type: 'number', default: 0.5, label: 'Z step', unit: 'mm' },
      zEnd: { type: 'number', default: 0, label: 'Z end', unit: 'mm' },
      passDepth: { type: 'number', default: 0.5, label: 'Pass depth', unit: 'mm' },
      finishPassDepth: { type: 'number', default: 0, label: 'Finish pass', unit: 'mm' },
    ...
    dragKnife: {
      bladeOffset: { type: 'number', default: 0.25, min: 0, label: 'Blade offset',
        unit: 'mm' },
      swivelToleranceDeg: { type: 'number', default: 5, min: 0, max: 180,
        label: 'Swivel tolerance', unit: 'deg' },
      swivelSegments: { type: 'number', default: 12, min: 3,
        label: 'Swivel segments' },
      z: { type: 'number', default: 0, label: 'Cut Z', unit: 'mm' },
      zStart: { type: 'number', default: 0, label: 'Z start', unit: 'mm' },
      zEnd: { type: 'number', default: 0, label: 'Z end', unit: 'mm' },
      passDepth: { type: 'number', default: 0.5, label: 'Pass depth', unit: 'mm' },
      finishPassDepth: { type: 'number', default: 0, label: 'Finish pass',
